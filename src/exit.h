...
constexpr bool is_exit(const position& pos, const bar& current) {
    ...
    return price >= pos.take_profit || price <= pos.stop_loss || price <= pos.trailing_stop;
}
...
namespace {
    ...
    static_assert([] {
        ...
        auto b = bar{.close = 110.0, .high = 110.5, .low = 109.0, .open = 109.5, .vwap = 109.8,
    ...
    static_assert([] {
        auto pos = position{100.0, 110.0, 90.0, 85.0};
        auto b = bar{.close = 89.0, .high = 90.5, .low = 88.5, .open = 90.0, .vwap = 89.5,
                     .volume = 1500, .num_trades = 75, .timestamp = "2025-01-01T10:00:00Z"};
        return is_exit(pos, b);
    }());
    ...
    static_assert([] {
        ...
        auto b = bar{.close = 94.0, .high = 95.5, .low = 93.5, .open = 95.0, .vwap = 94.5,
                     .volume = 1200, .num_trades = 60, .timestamp = "2025-01-01T10:00:00Z"};
        return is_exit(pos, b);
    }());
    ...
    static_assert([] {
        auto pos = position{100.0, 110.0, 90.0, 95.0};
        auto b = bar{.close = 105.0, .high = 106.0, .low = 103.5, .open = 104.0, .vwap = 104.8,
                     .volume = 800, .num_trades = 40, .timestamp = "2025-01-01T10:00:00Z"};
        return !is_exit(pos, b);
    }());
}
