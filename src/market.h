...
constexpr auto RISK_OFF_START = 45min; // Start liquidation before close (3:15 PM ET)
                                        // With 15-min data delay, gives ~30 min real time
...
static_assert(risk_off("2026-02-16T20:45:00Z"));  // 15:45 ET - still risk-off
